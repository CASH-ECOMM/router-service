...
public final class PaymentServiceDtoMapper {
    ...
    public static PaymentResponseDTO fromProto(PaymentResponse r) {
        ...
        if (r.hasReceiptInfo()) {
            ...
            // your UI DTO uses double; that’s fine — we’ll expose as 100.0 etc.
            b.receipt(PaymentResponseDTO.ReceiptDTO.builder()
                    ...
                    .itemCost(ri.getItemCost())           // int32 -> double widening
                    .shippingCost(ri.getShippingCost())   // int32 -> double widening
